...
const $$Privacy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Privacy;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "Our privacy policy will help you understand what information is collected and how it is used.", "title": "Privacy policy \xB7 Stone" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8"><div class="sm:pb:20 flex flex-col gap-4 pb-16 text-center"><h1 class="text-4xl font-medium tracking-tight sm:text-5xl">Privacy Policy</h1><p class="text-base">Last update: July 31, 2023</p></div><div><p class="mb-4">
...
Usage data: We may collect data about how you use our [website/app/service], including but
...
Cookies and similar technologies: We use cookies and similar technologies to enhance your
          experience, understand usage patterns, and improve our [website/app/service].
...
}, "C:/Users/HP TUPI S.A/OneDrive/Documentos/New Models/web-astro/astro-theme-stone/src/pages/privacy.astro", void 0);

const $$file = "C:/Users/HP TUPI S.A/OneDrive/Documentos/New Models/web-astro/astro-theme-stone/src/pages/privacy.astro";
const $$url = "/privacy";
